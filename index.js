...
const ownerNumber = ['243829465643']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("MR BLADE XMD~", '');
...
console.log("CONNECTING MR BLADE XMD 🧬...");
...
console.log('MR BLADE XMD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ Botname ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴍʀ ʙʟᴀᴅᴇ xᴍᴅ ✅*
...
*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: `your image url` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("24377777777")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("243777777777")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("243829465643")){
if(isReact) return
m.react("🦋")
   }

if(senderNumber.includes("243900365665")){
if(isReact) return
m.react("🎀")
   }
...
app.get("/", (req, res) => {
res.send("HEY, MR BLADE XMD STARTED ✅");
});
